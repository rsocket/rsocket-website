...
The full explanation of our motivations in creating a new protocol can be found in [Motivations](http://rsocket.io/docs/Motivations).
...
See also the RSocket [Motivations document](http://rsocket.io/docs/Motivations).
