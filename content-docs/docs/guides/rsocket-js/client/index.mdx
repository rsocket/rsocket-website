---
slug: /docs/guides/rsocket-js/client/index
title: rsocket-js Client
...
- [`rsocket-tcp-client`](./rsocket-tcp-client)
- [`rsocket-websocket-client`](./rsocket-websocket-client)
...
```
npm install rsocket-core rsocket-websockt-client
```

```js
import { RSocketClient } from 'rsocket-core';
import RSocketWebsocketClient from 'rsocket-websockt-client';
