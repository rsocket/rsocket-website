...
:::note
RSocketTCPClient is not supported in web browser environments. For web browser environments, [RSocketWebsocketClient](./rsocket-websocket-client) is recommended and supported.
:::
