...
*Line 12* instantiates an <b>RSocketClient</b>, and *line 13* sends the request.

The response is a <b>Payload</b> instance, the <b>data</b> of which is printed (*Line 15*).
