...
*Lines 18-57* defines an endpoint for sending statistics to the client. It uses the request-channel request type, which will allow
...
Next we will use this new handler in the <b>ChatClient</b>:
...
Call this new method from the client <b>main</b> method.
