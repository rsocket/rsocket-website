...
We will start with <b>server.py</b> and <b>client.py</b>. For now <b>shared.py</b> will be empty.
...
Here is the basic code for the <b>server.py</b> module:
...
*Lines 24-25* start a standard TCP server using the asyncio module.

*Lines 21-22* define that the response to this session will be instantiating an <b>RSocketServer</b>.
...
- handler_factory: A callable which returns an <b>RSocketHandler</b> instance. This will be used to respond to the chat client's requests.
...
- ensure_bytes : All values in a response must be either bytes or bytearrays. This method encodes str to bytes and assumes utf-8 for the input.
...
Here is the basic code for the <b>client.py</b> module:
...
*Line 11* instantiates an <b>RSocketClient</b>, and *line 12* sends the request. The response is a <b>Payload</b> instance, the <b>data</b> of which is printed (*Line 14*).
