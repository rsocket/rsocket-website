...
In this section we introduce the second argument which can be passed to routed endpoints. If rsocket is set up to use
composite metadata, <b>composite_metadata</b> will contain a parsed structure of the metadata in the request payload.
