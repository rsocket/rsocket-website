...
*Lines 21-31* define the <b>Subscriber</b> which will listen for incoming messages and print them on the client side.

An instance of the <b>MessageListener</b> is stored on the client (*Line 33*) to later allow stopping the incoming message stream.

*Lines 34-36* send the request and subscribe to the resulting <b>Publisher</b>.
