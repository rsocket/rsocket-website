...
We will use json to serialize the messages for transport. Add the following helper method to the <b>shared</b> module:
...
*Lines 8-9* Defines a helper method for creating `Payload`s containing only data fields.
