...
*Lines 20-37* define the publisher which will be returned.
...
The loop (*Lines 35-38*) is placed in an asyncio.Task which can be canceled by the client (*Lines 25-26*)
