...
Options:
  ...
  --fnf                           Fire and Forget
  -d, --data TEXT                 Data. Use "-" to read data from standard
                                  input. (default: )
...
```
rsocket-py --authSimple abc:12345 --route stream --allowUntrustedSsl --stream wss://localhost:6565
```
